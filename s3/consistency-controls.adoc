...
[[bucket-consistency-controlspecify-consistency-for-bucket]]
...
[[how-consistency-controls-and-ilm-rules-interacthow-consistency-and-ilm-rules-interact-to-affect-data-protection]]
