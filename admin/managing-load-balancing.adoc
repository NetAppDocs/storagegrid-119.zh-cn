...
NOTE: 虽然 StorageGRID 负载均衡器服务是推荐的负载均衡机制，但您可能需要集成第三方负载均衡器。有关信息，请联系您的 NetApp 客户代表或参阅 https://docs.netapp.com/us-en/storagegrid-enable/technical-reports/load-balancer-index.html["将第三方负载均衡器与 StorageGRID 结合使用"^]。
