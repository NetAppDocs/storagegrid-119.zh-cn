...
[[view-optimized-watermarksview-optimized-storage-watermarks]]
...
[[determine-optimized-watermarksdetermine-if-you-can-use-optimized-watermarks]]
...
[[use-optimized-watermarksuse-optimized-watermarks]]
